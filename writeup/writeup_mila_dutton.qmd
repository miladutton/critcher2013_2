...
After collecting and cleaning my data, I decided to perform effect size analysis. This was not in my original plan and the original paper did not clearly mention this process. However, I performed this analysis to provide more insight into the relationship between decision type, decision speed, and moral character evaluation.
...
![Graph from Original Paper](images/original_graph.png){width="500"}
