...
While the original study had 119 participants in experiment 1, ours had less for a number of reasons.

-   **Funding:** Due to limited funding, and the importance of fairly compensating participants, we had a smaller sample size than the original study.

-   **Dropout Rate:** To account for participants potentially not completing the study, we aimed to start with a larger sample size.

-   **Quality of Data:** To ensure we have enough good quality data, again we aimed to start with a larger sample size. If participants failed attention checks we were able to discard their data while still having enough good quality data.

-   **Participant Recruitment**: The availability of the target population may have influenced our recruitment ability, potentially impacting our planned sample size.
